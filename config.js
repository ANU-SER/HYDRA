...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝛨yDrA',
    ...
    BOT_INFO: process.env.BOT_INFO || 'HyDrA;6238560742;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝛨yDrA;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝛨yDrA' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '6238560742,0',
       DEBUG: DEBUG
};
